...
class DescriptionChecker:
    ...
    def _check_main_description(self, tool_name: str, description: Optional[str]) -> List[DescriptionIssue]:
    ...
    def _check_parameters(self, tool_name: str, schema: Dict[str, Any]) -> List[DescriptionIssue]:
    ...
    def _has_clear_purpose(self, description: str) -> bool:
        ...
        action_verbs = [
            ...
            'generate', 'calculate', 'validate', 'check'
        ]
