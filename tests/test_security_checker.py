...
def test_summarize_multiple_findings() -> None:
    ...
    findings = [
        SecurityFinding("1", "Title 1", "Desc 1", VulnerabilityLevel.CRITICAL, "Cat 1", "Comp 1"),
        SecurityFinding("2", "Title 2", "Desc 2", VulnerabilityLevel.HIGH, "Cat 2", "Comp 2"),
        SecurityFinding("3", "Title 3", "Desc 3", VulnerabilityLevel.HIGH, "Cat 3", "Comp 3"),
        SecurityFinding("4", "Title 4", "Desc 4", VulnerabilityLevel.MEDIUM, "Cat 4", "Comp 4"),
        SecurityFinding("5", "Title 5", "Desc 5", VulnerabilityLevel.MEDIUM, "Cat 5", "Comp 5"),
        SecurityFinding("6", "Title 6", "Desc 6", VulnerabilityLevel.MEDIUM, "Cat 6", "Comp 6"),
        SecurityFinding("7", "Title 7", "Desc 7", VulnerabilityLevel.LOW, "Cat 7", "Comp 7"),
        SecurityFinding("8", "Title 8", "Desc 8", VulnerabilityLevel.INFO, "Cat 8", "Comp 8"),
    ]
